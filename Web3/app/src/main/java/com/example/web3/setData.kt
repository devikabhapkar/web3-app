        ...
        planetlist.add(
            PlanetData(
                ...
                "What Is Blockchain Technology?\n" +
                        ...
                        "\n"+
                        " 1. An authorised participant inputs a transaction, which must be authenticated by the technology.\n" +
                        "\n"+
                        ...
                        "\n"+
                        " 4.uthorised nodes verify the transaction and add the block to the existing blockchain. (Nodes in public blockchain networks are referred to as miners; they're typically paid for this task -- often in a process called Proof of Work, or P.\n" +
                        "\n"+
                        " 5.The update is distributed across the network, which finalizes the transaction.\n" +
                        "\n"+
                        "TOP BLOCKCHAIN USES & APPLICATIONS:\n" +
                        "\n"+
                        " Cryptocurrency                              Cybersecurity                                          Accounting and record keeping                                   Supply chain                             Healthcare\n" +
        ...
        planetlist.add(
            PlanetData(
                ...
                " What Is a Non-Fungible Token (NFT)?\n " +
                        ...
                        "\n"+
                        "to its increasing popularity, people are now willing to pay hundreds of thousands of dollars for NFTs.\n" +
                        "\n"+
        ...
        planetlist.add(
            PlanetData(
                ...
                "What is edge computing?\n" +
                        ...
                        "                                                                                               The future of edge computing will come with its share of challenges. Edge solutions will require many vendors, increasing complexity. Every new network connection, smart device, edge server, or micro data center becomes an attack surface for hackers. In addition, edge computing could create sustainability issues due to more hardware everywhere, which leads to more energy, more heat, and more electronic waste."
            )
        )
        planetlist.add(
            PlanetData(
        ...
        planetlist.add(
            PlanetData(
                ...
                "What Is Decentralized Finance (DeFi)?\n" +
                        ...
                        "\n"+
                        "The blocks are \"chained\" together through the information in each proceeding block, giving it the name blockchain. Information in previous blocks cannot be changed without affecting the following blocks, so there is no way to alter a blockchain. This concept, along with o\n" +
                        "\n" +
                        "The Future of DeFi:\n" +
                        "\n" +
        ...
        planetlist.add(
            PlanetData(
                ...
                " What Is a Decentralized Autonomous Organization (DAO)?\n"+
                        ...
                        "\n" +
                        "The Future of DAOs\n" +
                        "Over the past few years, we have seen a number of successful DAOs emerge, including TheDAO, Aragon, and MakerDAO.\n" +
                        "\n" +
                        "As the technology matures, we can expect to see even more innovative and impactful DAOs emerge. With their ability to create vast networks of interconnected people and organizations, DAOs have the potential to redefine the way we live and work together."
            )
        )
        planetlist.add(
            PlanetData(
        ...
        planetlist.add(
            PlanetData(
                ...
                "World’s Prominent Companies in the Web 3.0 Market: Top 10 By Revenue\n" +
                        "\n" +
                        "1.Helium Systems, Inc. \n" +
                        "2.Coinbase Global, Inc. \n" +
                        "3.Polygon Technology\n" +
                        "4.ConsenSys \n" +
                        "5.CoinSwitch Kuber\n" +
                        "6.Alchemy Insights, Inc. \n" +
                        "7.Web3 Foundation \n" +
                        "8.Brave Software, Inc. \n" +
                        "9.Biconomy \n" +
                        "10.Huddle01"
            )
        )
